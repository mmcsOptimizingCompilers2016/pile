...
3.  [Оптимизации внутри базового блока](#оптимизации-внутри-базового-блока)
       1. [Def-Use информация о переменных](#def-use-информация-внутри-блока)
       2. [Удаление мертвого кода](#удаление-мертвого-кода)
       3. [Свертка констант](#свертка-констант)
...
4.  [Оптимизации между базовыми блоками](#оптимизации-между-базовыми-блоками)
    ...
    3. [Оптимизация общего итерационного алгоритма](#оптимизация-общего-итерационного-алгоритма)
          ...
          3. [Оптимизированная версия итерационного алгоритма](#оптимизированная-версия-итерационного-алгоритма)
              1. [Сравнение с неоптимизированной версией](#оптимизированная-версия-итерационного-алгоритма)
