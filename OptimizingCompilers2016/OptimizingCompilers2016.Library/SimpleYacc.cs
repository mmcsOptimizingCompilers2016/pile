...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-14,5,-8,68,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    states[5] = new State(new int[]{4,6,32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-8,7,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    ...
    states[14] = new State(new int[]{12,15,13,25,10,-31,11,-31,7,-31,19,-31,9,-31,24,-31,25,-31,26,-31,27,-31,28,-31,29,-31,32,-31,3,-31,5,-31,15,-31,18,-31,21,-31,23,-31,16,-31,20,-31,4,-31,17,-31,22,-31});
    ...
    states[24] = new State(new int[]{12,15,13,25,10,-32,11,-32,7,-32,19,-32,9,-32,24,-32,25,-32,26,-32,27,-32,28,-32,29,-32,32,-32,3,-32,5,-32,15,-32,18,-32,21,-32,23,-32,16,-32,20,-32,4,-32,17,-32,22,-32});
    states[25] = new State(new int[]{32,18,30,19,8,20},new int[]{-4,26,-2,17});
    states[26] = new State(-35);
    states[27] = new State(-33);
    states[28] = new State(new int[]{12,15,13,25,10,-30,11,-30,7,-30,19,-30,9,-30,24,-30,25,-30,26,-30,27,-30,28,-30,29,-30,32,-30,3,-30,5,-30,15,-30,18,-30,21,-30,23,-30,16,-30,20,-30,4,-30,17,-30,22,-30});
    states[29] = new State(-6);
    states[30] = new State(-7);
    states[31] = new State(new int[]{32,18,30,19,8,20},new int[]{-6,32,-3,53,-1,54,-5,28,-4,27,-2,17});
    states[32] = new State(new int[]{32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-8,33,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    states[33] = new State(-15);
    states[34] = new State(-8);
    states[35] = new State(new int[]{32,18,30,19,8,20},new int[]{-6,36,-3,53,-1,54,-5,28,-4,27,-2,17});
    states[36] = new State(new int[]{16,37});
    states[37] = new State(new int[]{32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-8,38,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    states[38] = new State(new int[]{17,39,4,-16,32,-16,3,-16,5,-16,15,-16,18,-16,21,-16,23,-16,22,-16});
    states[39] = new State(new int[]{32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-8,40,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    states[40] = new State(-17);
    states[41] = new State(-9);
    states[42] = new State(new int[]{32,18},new int[]{-7,43,-2,10});
    states[43] = new State(new int[]{19,44});
    states[44] = new State(new int[]{32,18,30,19,8,20},new int[]{-1,45,-5,28,-4,27,-2,17});
    states[45] = new State(new int[]{20,46,10,13,11,23});
    states[46] = new State(new int[]{32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-8,47,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    states[47] = new State(-20);
    states[48] = new State(-10);
    states[49] = new State(new int[]{32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-14,50,-8,68,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    states[50] = new State(new int[]{22,51,32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-8,7,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    states[51] = new State(new int[]{32,18,30,19,8,20},new int[]{-6,52,-3,53,-1,54,-5,28,-4,27,-2,17});
    states[52] = new State(-18);
    states[53] = new State(-27);
    states[54] = new State(new int[]{10,13,11,23,24,57,25,58,26,59,27,60,28,61,29,62,32,-28,3,-28,5,-28,15,-28,18,-28,21,-28,23,-28,16,-28,4,-28,17,-28,22,-28,20,-28},new int[]{-16,55});
    states[55] = new State(new int[]{32,18,30,19,8,20},new int[]{-1,56,-5,28,-4,27,-2,17});
    states[56] = new State(new int[]{10,13,11,23,32,-29,3,-29,5,-29,15,-29,18,-29,21,-29,23,-29,16,-29,4,-29,17,-29,22,-29,20,-29});
    states[57] = new State(-21);
    states[58] = new State(-22);
    states[59] = new State(-23);
    states[60] = new State(-24);
    states[61] = new State(-25);
    states[62] = new State(-26);
    states[63] = new State(-11);
    states[64] = new State(new int[]{32,18,30,19,8,20},new int[]{-6,65,-3,53,-1,54,-5,28,-4,27,-2,17});
    states[65] = new State(new int[]{20,66});
    states[66] = new State(new int[]{32,18,3,4,5,31,15,35,18,42,21,49,23,64},new int[]{-8,67,-7,8,-2,10,-15,29,-9,30,-10,34,-13,41,-11,48,-12,63});
    ...
    rules[16] = new Rule(-10, new int[]{15,-6,16,-8});
    rules[17] = new Rule(-10, new int[]{15,-6,16,-8,17,-8});
