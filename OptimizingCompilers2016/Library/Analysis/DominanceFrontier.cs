...
namespace OptimizingCompilers2016.Library.Analysis
{
    public class DominanceFrontier
    {
        ...
        public DominanceFrontier(List<BaseBlock> blocks)
        {
            this.blocks = blocks;
        ...
        public HashSet<string> ComputeIDF(List<BaseBlock> blocks)
        {
        ...
        public HashSet<string> ComputeIDF(BaseBlock block)
        {
            HashSet<string> IDF = new HashSet<string>();
            HashSet<string> oldIDF = new HashSet<string>();
            HashSet<string> DF_S = new HashSet<string>();
        ...
        public override string ToString()
        {
            ...
            //res += "IDF({" + string.Join(", ", blocks.Select((BaseBlock bl) => { return bl.Name; })) + "}) = {"+  string.Join(", ", IDF) + "}";
