...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-14,5,-8,69,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[5] = new State(new int[]{4,6,32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-8,7,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[6] = new State(-14);
    states[7] = new State(-4);
    states[8] = new State(new int[]{7,9});
    states[9] = new State(-5);
    states[10] = new State(new int[]{6,11});
    states[11] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-1,12,-5,28,-4,27,-2,17});
    ...
    states[20] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-1,21,-5,28,-4,27,-2,17});
    ...
    states[29] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-1,30,-5,28,-4,27,-2,17});
    states[30] = new State(new int[]{10,13,11,23,7,-33,19,-33,9,-33,24,-33,25,-33,26,-33,27,-33,28,-33,29,-33,32,-33,3,-33,5,-33,15,-33,18,-33,21,-33,23,-33,20,-33,4,-33,17,-33,22,-33});
    states[31] = new State(-6);
    states[32] = new State(-7);
    states[33] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-6,34,-3,54,-1,55,-5,28,-4,27,-2,17});
    states[34] = new State(new int[]{32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-8,35,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[35] = new State(-15);
    states[36] = new State(-8);
    states[37] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-6,38,-3,54,-1,55,-5,28,-4,27,-2,17});
    states[38] = new State(new int[]{32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-8,39,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[39] = new State(new int[]{17,40,4,-16,32,-16,3,-16,5,-16,15,-16,18,-16,21,-16,23,-16,22,-16});
    states[40] = new State(new int[]{32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-8,41,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[41] = new State(-17);
    states[42] = new State(-9);
    states[43] = new State(new int[]{32,18},new int[]{-7,44,-2,10});
    states[44] = new State(new int[]{19,45});
    states[45] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-1,46,-5,28,-4,27,-2,17});
    states[46] = new State(new int[]{20,47,10,13,11,23});
    states[47] = new State(new int[]{32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-8,48,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[48] = new State(-20);
    states[49] = new State(-10);
    states[50] = new State(new int[]{32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-14,51,-8,69,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[51] = new State(new int[]{22,52,32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-8,7,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    states[52] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-6,53,-3,54,-1,55,-5,28,-4,27,-2,17});
    states[53] = new State(-18);
    states[54] = new State(-27);
    states[55] = new State(new int[]{10,13,11,23,24,58,25,59,26,60,27,61,28,62,29,63,32,-28,3,-28,5,-28,15,-28,18,-28,21,-28,23,-28,4,-28,17,-28,22,-28,20,-28},new int[]{-16,56});
    states[56] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-1,57,-5,28,-4,27,-2,17});
    states[57] = new State(new int[]{10,13,11,23,32,-29,3,-29,5,-29,15,-29,18,-29,21,-29,23,-29,4,-29,17,-29,22,-29,20,-29});
    ...
    states[65] = new State(new int[]{32,18,30,19,8,20,11,29},new int[]{-6,66,-3,54,-1,55,-5,28,-4,27,-2,17});
    states[66] = new State(new int[]{20,67});
    states[67] = new State(new int[]{32,18,3,4,5,33,15,37,18,43,21,50,23,65},new int[]{-8,68,-7,8,-2,10,-15,31,-9,32,-10,36,-13,42,-11,49,-12,64});
    ...
    rules[33] = new Rule(-1, new int[]{11,-1});
    rules[34] = new Rule(-5, new int[]{-4});
    rules[35] = new Rule(-5, new int[]{-5,12,-4});
    rules[36] = new Rule(-5, new int[]{-5,13,-4});
    rules[37] = new Rule(-4, new int[]{-2});
    rules[38] = new Rule(-4, new int[]{30});
    rules[39] = new Rule(-4, new int[]{8,-1,9});
  }
...
{ CurrentSemanticValue.eVal = new BinExprNode(new IntNumNode(0), BinSign.MINUS, ValueStack[ValueStack.Depth-1].eVal); }
        break;
      case 34: // m_d -> in_br
{ CurrentSemanticValue.eVal = ValueStack[ValueStack.Depth-1].eVal; }
        break;
      case 35: // m_d -> m_d, MULT, in_br
...
{ CurrentSemanticValue.eVal = new IntNumNode(ValueStack[ValueStack.Depth-1].iVal); }
        break;
      case 39: // in_br -> LBRACE, expr, RBRACE
